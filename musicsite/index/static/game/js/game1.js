...
function create() {
    ...
    text = game.add.text(0, 0, words[0], style);
    text.anchor.set(0.5);
	/* end text on sprite */
...
function update() {
	text.x = Math.floor(eSprite.x + eSprite.width/2.0 - text.width/2);
    text.y = Math.floor(eSprite.y + eSprite.height/2.0 - text.height/2);
